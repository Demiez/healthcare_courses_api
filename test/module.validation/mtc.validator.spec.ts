...
describe('UT - MtcRequestModelValidator', () => {
  const sandbox = sinon.createSandbox();
  let testData: MtcRequestModel;

  class MtcRequestModelValidatorTester extends MtcRequestModelValidator {
    constructor() {
      super();
    }
  }
  ...
  beforeEach(async () => {
    sandbox.spy(MtcRequestModelValidatorTester, 'validate');
  });
  ...
  describe(':: email validation', () => {
    ...
    it('should return FieldIsBadModel when email is not a string', async () => {
      ...
      testValueProvidedCase(MtcRequestModelValidatorTester.validate, testData, [
        new FieldIsBadModel('email', BaseValidationMessagesEnum.MUST_BE_STRING),
      ]);
    });
  ...
  describe(':: phone validation', () => {
    ...
    it('should return FieldIsBadModel when phone is not a string', async () => {
      ...
      testValueProvidedCase(MtcRequestModelValidatorTester.validate, testData, [
        new FieldIsBadModel('phone', BaseValidationMessagesEnum.MUST_BE_STRING),
      ]);
    });
  ...
  describe(':: photo validation - optional field', () => {
    ...
    it('should return FieldIsBadModel when photo is not a string', async () => {
      ...
      testValueProvidedCase(MtcRequestModelValidatorTester.validate, testData, [
        new FieldIsBadModel('photo', BaseValidationMessagesEnum.MUST_BE_STRING),
      ]);
    });
  });
